...
func tsetNew(ed *Editor, m *hub.Msg) error {
	req := ParseName(m)
...
func tsetDel(ed *Editor, m *hub.Msg) error {
...
func tsetEdit(ed *Editor, m *hub.Msg) error {
...
func lvlNew(ed *Editor, m *hub.Msg) error {
	req := ParseName(m)
...
func lvlDel(ed *Editor, m *hub.Msg) error {
...
func lvlEdit(ed *Editor, m *hub.Msg) error {
	var req lvl.Lvl
	m.Unmarshal(&req)
...
func gridOpen(ed *Editor, m *hub.Msg) error {
	req := ParseID[ids.Lvl](m)
	...
	// TODO manage grid subscriptions, every user can only be subscribed to one grid.
	hub.Send(m.From, site.RawMsg(m.Subj, g))
	return nil
}

func gridEdit(ed *Editor, m *hub.Msg) error {
